...
1. 使用手机号登录 2. 忘记密码? (待做接口)
2. 注册的密码先不校验
3. chongbi/USDT  ->显示的是 充币地址 是缩写的 555 - 余额前面显示备注(加粗 如果有) 外面默认显示地址
4. 提币成功 - 跳到提示页面
5. 全部公链->钱包地址
6. USDT地址管理 -> 地址管理 (非USDT会崩)
7. 注册 
8. 我的- 隐藏推荐站长 有奖反馈
	1. 法币国家->选择法币(显示上已选国家)
9. 实名认证-> 删掉未实名卡片 
	1. realNameStatus 0未认证 1审核中 2已完成
	2. 立即认证按钮 在状态0时才显示
10. 游戏钱包设置->钱包设置
	1. 去掉您的邮箱账号
11. KZ钱包->游戏钱包
	1. action只保留 明细 左边放个扫码的
12. 买卖 一进去 是在售列表
	1. 头像太小了
13. 隐藏开始搬砖
14. 订单
	1. 订单项 - 复制
	2. 付款(购买)方  里外都可以延长时间 , "validTime": 149<120
	3. 买卖切订单, 进行中没有了
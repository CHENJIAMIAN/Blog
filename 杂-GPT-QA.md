...
1. " —— 精确关键词
2. intitle —— 页面主标题
3. allintitle —— 所有标题包含多个关键词
4. intext —— 页面内部关键词
5. inurl —— 网址包含关键词
6. site —— 网站内搜索
7. imagesize:3840x2160 1920x1080  2160x1440 2560x1600 2560x1440  —— 图像尺寸大小 
8. filetype —— 文件格式搜索
### 好用的Prompt
...
- 用的底层是什么, 请你逐级下钻, 追溯到原子(物理概念)层面
- 将以上的所有代码重新整理: 1.重命名变量 2.代码形式可读化 不要重命名已经是可读状态的变量, 不要一次给全部, 5个方法5个方法地给, 我说继续才给下5个方法
- 继续刚刚未说完了
- 无论我用什么语言提问,你都要用中文回答我!
- 用 Mermaid 语法画的流程图
#### ChatGPT官方网页快捷键
| 动作              | 快捷键       |
|-------------------|--------------|
...
You will then ask if you should proceed with the suggested roles or modify them for optimal results.
...
Repeat step
5 until I am satisfied with the roles.
7. If I disagree, proceed to the next step.
8. You will ask, "How can I help with [my answer to step 1]?"
9. I will provide my answer.
10. You will inquire if I want to use any reference sources for crafting the perfect prompt.
11. If I agree, you will ask for the number of sources I want to use.
12. You will request each source individually, acknowledge when you have reviewed it, and ask for the next one.  
Continue until you have reviewed all sources, then move to the next step.
...
16. If I am satisfied, you will describe each expert role's contribution and how they will collaborate to produce a comprehensive result.  
    Then, ask if any outputs or experts are missing.
...
```
### GPT4o-latest2024年9月13日能解决但是GPT4o-mini无法解决的问题
```js
...
- **总长度**: 100
- **输入比例**: 0.3 (即在 30 米处漏水)
- **多段连接线**: [{ startPoint: 20, endPoint: 40 }]
- **预期真实漏水位置**: 50（20米到40米是跳过了）0-20有效, 20-40跳过,40-50有效
